...
module.exports.WG_IFNAME = process.env.WG_IFNAME || 'wg0';
...
iptables -A FORWARD -i ${module.exports.WG_IFNAME} -j ACCEPT;
iptables -A FORWARD -o ${module.exports.WG_IFNAME} -j ACCEPT;
`.split('\n').join(' ');
...
iptables -D FORWARD -i ${module.exports.WG_IFNAME} -j ACCEPT;
iptables -D FORWARD -o ${module.exports.WG_IFNAME} -j ACCEPT;
`.split('\n').join(' ');
